...
def _build_same_shell_target_row_language(
    *,
    ...
    return {
        ...
        "_compatibility_rows": list(compatibility.get("global_matrix_rows", [])),
    }
...
def _build_generic_target_row_language(
    *,
    ...
    return _build_same_shell_target_row_language(
        shared={
            "group_id": group_id,
            "mode": mode,
            "target_point_ids": list(target_point_ids),
        ...
        bs_analysis={"unknown_ordering": list(current_unknown_ordering)},
    )
...
def _build_same_shell_target_quotient(
    *,
    ...
    compatibility_rows = list(target_row_language.get("_compatibility_rows", []))
...
def _build_generic_target_quotient(
    *,
    ...
    return _build_same_shell_target_quotient(
        ...
        bs_analysis_current=bs_analysis_current,
        induced=induced,
    )
