...
def build_point_row_translation_legality_report(
    ...
    return {
        ...
        "legality_reason": (
            "phase-aware point-row translation is not retained on the published final "
            "point/path shell because the translated seed does not dominate the raw seed "
            "mechanically on the regenerated 34-unknown compatibility object."
    ...
    *,
    ...
    summary = {
        ...
        "BS_status": {
            ...
            "strong_equivalence_pass": reduction_reports["bs_strong_equivalence_report"]["bs_strong_equivalence_pass"],
        },
        "AI_status": {
    ...
    lines = [
        ...
        f"- Strong BS equivalence against the full candidate path language: `{reduction_reports['bs_strong_equivalence_report']['bs_strong_equivalence_pass']}`.",
        "",
    ...
    write_json(
        DOUBLE_BS_JSON,
        {
            **bs_analysis,
            ...
            "bs_strong_equivalence_pass": single_kgeom["final_object_reduction"]["selected_rows_span_full_candidate_row_language"],
        },
    )
    write_json(
        DOUBLE_MINIMAL_JSON,
