...
- `c_A1'`: numeric=`non_integral`, exact=`non_integral`, integral_success=`False`, exact_matches_numeric=`True`.
- `d_A1'`: numeric=`non_integral`, exact=`non_integral`, integral_success=`False`, exact_matches_numeric=`True`.
