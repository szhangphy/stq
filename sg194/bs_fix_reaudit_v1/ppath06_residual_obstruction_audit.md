...
- Explanation: The three publication rows on PPATH06 are inherited directly from raw L2 via the internal FPATH07 layer. All three rows are pure pair-difference constraints on P3 multiplicities, so residuals survive publication reduction without involving any new P4-only terms.
