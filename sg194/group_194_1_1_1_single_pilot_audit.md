...
- The current pilot had to add `5` synthetic 0D boundary points because the raw k-geometry contains `3` line endpoints that are not emitted by `swyckoff_k.py` as separately listed special points.
...
- BS matrix shape/rank/nullity: `[58, 62]`, `33`, `29`.
