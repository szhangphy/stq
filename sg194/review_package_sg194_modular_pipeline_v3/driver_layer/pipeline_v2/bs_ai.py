...
def build_result_objects(
    ...
    if _is_generic_spec(spec):
        if geometry is None or alignment is None:
            raise ValueError("generic symmetry-ops specs require geometry and alignment summaries")
        return _build_generic_result_objects(spec, geometry, alignment)
