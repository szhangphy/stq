...
def validate_outputs() -> None:
    ...
    if current_status["published_result_scope"] == "benchmark_aligned_publication_not_yet_internalized":
...
def main() -> None:
    ...
    current_status = {
        ...
        "double_internalization_target_object_match": double_internalization["current_to_external_generator_space_identity"],
        "double_internalization_quotient_derivation_mode": double_internalization["quotient_derivation_mode"],
        "double_internalization_quotient_direct_current_lattice_derivation": double_internalization[
