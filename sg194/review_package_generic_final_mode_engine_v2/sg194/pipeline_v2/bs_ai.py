        ...
        records.append(
            {
                ...
                "row_language_kind": target_alignment.get("row_language_kind", "target_row_language_not_yet_built"),
                "object_kind": target_alignment.get("object_kind", "generic_target_object_pending"),
