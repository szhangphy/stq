...
- Trivial-family AI seed count/rank: `10` / `10`.
- Trivial-family compatibility-zero count: `4` / `10`.
- Library-integrated single AI candidate count / failures / compatibility-zero candidates: `33` / `12` / `11`.
- AI obstruction classification counts: `{'fails_on_raw42': 22, 'compatible_on_publication_shell': 11, 'induction_failure_on_raw42': 12}`.
