...
def _build_generic_compatibility(
    ...
    for line in grouped["lines"]:
        ...
        line_builder_compare.append(
            {
                "line_id": line["id"],
                "primary_builder_kind": block.get("restriction_class_builder", {}).get(
                    "builder_kind",
                    "restriction_class_primary_with_instance_star_continuation_v3",
                ),
                "primary_equation_count": len(block.get("equations", [])),
                "primary_refinement_row_count": block.get("restriction_class_builder", {}).get("refinement_row_count", 0),
    ...
    return {
        ...
        "compatibility_builder_kind": "generic_restriction_class_primary_line_builder_with_instance_level_star_awareness",
...
def _build_quotient_from_candidates(
    ...
    return {
        "dBS": bs_rank,
        "dAI": ai_rank,
        "dbs_dai_gap": int(bs_rank - ai_rank),
        "free_rank": free_rank,
