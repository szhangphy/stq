...
def _build_line_block_from_restriction_classes(
    ...
    *,
    ...
    builder_kind = (
        "intrinsic_line_restriction_classes_only_v1"
        if builder_variant == "intrinsic"
        else "extrinsic_star_augmented_line_restriction_classes_v1"
    )
    return {
        **coarse_block,
        "status": "success",
...
def build_line_block(
    ...
    *,
    ...
    if builder_variant == "coarse":
        return build_line_block_from_coarse_restriction(line_obj, captures, field="linear_character")
    if builder_variant == "intrinsic":
        return build_line_block_from_intrinsic_restriction_classes(line_obj, captures, field="linear_character")
    if builder_variant == "extrinsic":
        return build_line_block_from_extrinsic_star_augmented_classes(line_obj, captures, field="linear_character")
