...
class GenericDiagnosticAdapter:
    ...
    def _record_as_final(record: dict[str, Any]) -> dict[str, Any]:
        published = bool(record.get("classification_is_published_final", False))
        return {
            "object_kind": record["object_kind"],
            "dBS": record.get("dBS") if published else None,
            "dAI": record.get("dAI") if published else None,
            "classification": record.get("classification") if published else None,
        ...
        return [
            ...
            },
            {
                ...
                "passed": (
                    ...
                    or final_status.get("final_result_mode") in {"generic_final", "diagnostic_only"}
                ),
                "actual": {
