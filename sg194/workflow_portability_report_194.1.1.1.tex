...
\[
\mathrm{shape}(C_{\mathrm{single}}) = 58 \times 42, \qquad
\operatorname{rank} C_{\mathrm{single}} = 26, \qquad
\operatorname{nullity} C_{\mathrm{single}} = 16.
\]
...
\[
\mathrm{shape}(C_{\mathrm{double}}) = 58 \times 42, \qquad
\operatorname{rank} C_{\mathrm{double}} = 26, \qquad
\operatorname{nullity} C_{\mathrm{double}} = 16.
\]
