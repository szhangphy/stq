...
\[
\mathrm{shape}(C_{\mathrm{double}}) = 58 \times 62, \qquad
\operatorname{rank} C_{\mathrm{double}} = 33, \qquad
\operatorname{nullity} C_{\mathrm{double}} = 29.
\]
